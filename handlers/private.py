            ...
            [
                [
                    InlineKeyboardButton(
                        "🎼 Asistan", url="https://t.me/winampmuzikasistan"
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Sohbet Grubu", url=f"https://t.me/ExtremeSohbett"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Kanalı', url=f"https://t.me/Extremekanallar"),
            [InlineKeyboardButton(text = '👨‍💻 Sahip 👨‍💻', url=f"https://OrmanCocuklariylaMucadele")],
